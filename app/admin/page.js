...
const FIELD_LABELS = {
  ...
  mahilaSpeaker: "Speakers conveyed the message effectively?",
  balSpeaker: "Speakers conveyed the message effectively?",
  emsSpeaker: "Speakers conveyed the message effectively?",
  mahilaSpeakerReason: "Elaboration (if other)",
  balSpeakerReason: "Elaboration (if other)",
  emsSpeakerReason: "Elaboration (if other)",
  mahilaAnchoring: "Saints performing Manch Sanchalan sewa",
  balAnchoring: "Saints performing Manch Sanchalan sewa",
  emsAnchoring: "Saints performing Manch Sanchalan sewa",
  ...
  mahilaFeedback: "Feedback",
  balFeedback: "Feedback",
  emsFeedback: "Feedback",
  pracharakName: "Pracharak Mahatma name",

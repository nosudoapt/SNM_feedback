...
const FIELD_LABELS = {
  ...
  mahilaConcept: "Was the concept/topic of the discourse clear?",
  balConcept: "Was the concept/topic of the discourse clear?",
  emsConcept: "Was the concept/topic of the discourse clear?",
